...
string _srs_system_username;

bool srs_set_login_username(string username) 
{
    if (username.size() <= 0) {
        return false;
    }
    _srs_system_username = username;
    return true;
}

bool srs_get_login_username(string &username)
{
    if (username.size() <= 0) {
        return false;
    }
    username = _srs_system_username;
    return true;
}
